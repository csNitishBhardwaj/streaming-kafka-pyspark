...
from config import BOOTSTRAP_SERVERS, CONSUME_TOPIC_RIDES_CSV,TOPIC_WINDOWED_VENDOR_ID_COUNT
...
if __name__ == '__main__':
    ...
    parser.add_argument('--topic', type=str, default=TOPIC_WINDOWED_VENDOR_ID_COUNT)
